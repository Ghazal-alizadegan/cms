...
<head>
    ...
    <link href="css/styleinbox.css" rel="stylesheet">
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a class="" href="dashbord.php?m=menu&p=add">ایجاد منوی جدید</a></li>
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت سرگروه محصول</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=product_pr&p=list">لیست سرگروه محصول</a></li>
                            <li><a class="" href="dashbord.php?m=product_pr&p=add">ایجاد سرگروه جدید</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=product&p=list">لیست محصولات ها</a></li>
                            <li><a class="" href="dashbord.php?m=product&p=add">ایجاد محصول جدید</a></li>
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت سرگروه اخبار</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=news_pr&p=list">لیست سرگروه اخبار</a></li>
                            <li><a class="" href="dashbord.php?m=news_pr&p=add">ایجاد سرگروه جدید</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a class="" href="dashbord.php?m=news&p=add">ایجاد خبر جدید</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت تماس با ما</span>
                            <span class="arrow"></span>
                        </a>
                            <ul class="sub">
                                <li><a class="" href="dashbord.php?m=contact&p=list">لیست تماس با ما</a></li>
                            </ul>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashbord.php?m=setting&p=editindex"> ویرایش تنظیمات  صفحه اصلی </a></li>
                        <li><a class="" href="dashbord.php?m=setting&p=editcontact"> ویرایش تنظیمات  صفحه تماس با ما </a></li>
                    </ul>
                </li>
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت ویجت زیر اسلاید</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=widget&p=list">لیست ویجت ها</a></li>
                            <li><a class="" href="dashbord.php?m=widget&p=add">ایجاد ویجت جدید</a></li>
                        </ul>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=page&p=list">لیست صفحات</a></li>
                            <li><a class="" href="dashbord.php?m=page&p=add">ایجاد صفحه جدید</a></li>
                        </ul>
